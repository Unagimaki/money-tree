...
export const OfferModal = () => {
	...
	const handleCheck = () => {
		if (url.startsWith('https://t.me/')) {
			...
			WebApp.openTelegramLink(opening_url)
			console.log({opening_url})

		} else if (url.startsWith('https://partners2')) {
			const opening_url = updatedUrl(url, 'clickid', tgId)
			WebApp.openLink(opening_url)
			console.log({opening_url})

		} else if (url.startsWith('https://redirect.ligapartners')) {
