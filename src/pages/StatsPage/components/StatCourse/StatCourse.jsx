import styles from './statCourse.module.scss'

export const StatCourse = () => {
    const money_icon = require('../../assets/money_icon.png')
    return (
      <div className={styles.container}>
        <div className={styles.container_inner}>
          <div style={{ opacity: 0.6 }}>Курс: </div>
          <div>10,000,000</div>
          <img src={money_icon} alt="money_icon" />=<div>1</div>
          <div className={styles.container_inner_dollar_icon}>
            <svg
